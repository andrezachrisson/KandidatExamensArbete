...
plot 'Orient_KAPPA0P1' with linespoints ls 1 title 'Kappa = 0.1', \
'Orient_KAPPA0P2' with linespoints ls 2 title 'Kappa = 0.2',\
'Orient_KAPPA0P3' with linespoints ls 3 title 'Kappa = 0.3',\
'Orient_KAPPA0P5' with linespoints ls 4 title 'Kappa = 0.5',\
'Orient_KAPPA0P7' with linespoints title 'Kappa = 0.7',\
'Orient_KAPPA0P8' with linespoints title 'Kappa = 0.8',
