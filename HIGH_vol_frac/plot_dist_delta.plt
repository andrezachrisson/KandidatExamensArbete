...
'distribution_KAPPA0P2' with linespoints ls 2 title 'Kappa = 0.2',\
'distribution_KAPPA0P3' with linespoints ls 3 title 'Kappa = 0.3',\
'distribution_KAPPA0P5' with linespoints ls 4 title 'Kappa = 0.5',\
'distribution_KAPPA0P7' with linespoints title 'Kappa = 0.7',\
'distribution_KAPPA0P8' with linespoints title 'Kappa = 0.8',
